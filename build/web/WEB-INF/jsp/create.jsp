<%-- 
    Document   : create
    Created on : 11/06/2015, 02:03:55
    Author     : maicon
--%>
...
<html>
    ...
    <body>
        <div id="body"> <h1>Novo Post</h1>
            <c:url var="url" value="/posts" />
            <form:form action="${url}" method="POST" modelAttribute="post"> 
                <p> 
                    <label for="title">Title:</label> <form:errors path="title" cssClass="error"/><br />
                ...
                <div id="menu"> <a href="<c:url value="/posts"/>">Ver todos</a>
                </div>
        </div> 
    </body>
</html>
